...
arrayShiftPush(_array,_value) =>
    array.shift(_array)
    array.push(_array,_value)
arrayInsertPush(_array,_value1,_value2) =>
    array.shift(_array)
    array.pop(_array)
    array.push(_array,_value1)
    array.push(_array,_value2)
...
var min = 2.00
var max = 0.00
var position1 = bar_index
var position2 = bar_index
var ETL = array.new_float(0)
...
if(array.get(arrayY,4) > array.get(arrayY,3) and array.get(arrayY,4) < array.get(arrayY,2))
    arrayPopPush(arrayX,bar_index)
	arrayPopPush(arrayY,high[0])
    if high[0] > max
        max := high[0]
        position1 := bar_index
else if (array.get(arrayY,4) < array.get(arrayY,3) and array.get(arrayY,4) > array.get(arrayY,2))
    arrayPopPush(arrayX,bar_index)
	arrayPopPush(arrayY,low[0])
    if low[0] < min
        min := low[0]
        position2 := bar_index
else if (array.get(arrayY,2) >= array.get(arrayY,3) and array.get(arrayY,3) >= array.get(arrayY,4) and min >0)
    arrayInsertPush(arrayY,min,low[0])
    arrayInsertPush(arrayX,position2,bar_index)
    drawLine := 3
    min := 0
else if (array.get(arrayY,2) < array.get(arrayY,3) and array.get(arrayY,3) < array.get(arrayY,4) and max >0)
    arrayInsertPush(arrayY,max,high[0])
    arrayInsertPush(arrayX,position1,bar_index)
    drawLine := 3
    max :=0
else 
...
plotchar( highPrev[1], "highPrev", "", location = location.top)
plotchar( array.get(arrayY,4), "array.get(arrayY,4)", "", location = location.top)
plotchar( array.get(arrayX,4), "array.get(arrayX,4)", "", location = location.top)
plotchar( array.get(arrayY,3), "array.get(arrayY,3)", "", location = location.top)
plotchar( array.get(arrayX,3), "array.get(arrayX,3)", "", location = location.top)
plotchar( array.get(arrayY,2), "array.get(arrayY,2)", "", location = location.top)
plotchar( array.get(arrayX,2), "array.get(arrayX,2)", "", location = location.top)
plotchar( array.get(arrayY,1), "array.get(arrayY,1)", "", location = location.top)
plotchar( array.get(arrayX,1), "array.get(arrayX,1)", "", location = location.top)
plotchar( min, "min", "", location = location.top)
plotchar( max, "min", "", location = location.top)
plotchar( position1, "position1", "", location = location.top)
plotchar( high[0], "high", "", location = location.top)
